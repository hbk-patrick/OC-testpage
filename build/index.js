...
(() => {
  ...
  var addToCartURI = `/ajax/api/JsonRPC/Commerce/?Commerce/[Checkout::addItemToCart]`;
  var addItemToShippingCart = async (cartToken) => {
    ...
    const response = await axiosClient.post(cartToken ? `${addToCartURI}&cartToken=${cartToken}` : addToCartURI, shippingCartPayload);
